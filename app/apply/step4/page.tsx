		...
		>
			<div className="relative mx-[2.5%] mt-[4vh] mb-[2vh]">
				...
				<div className="relative z-10 w-[86%] mx-auto pt-[3vh] pb-[4vh]">
					...
					<form className="flex flex-col gap-[3vh]" onSubmit={(e) => { e.preventDefault(); handleNext(); }}>
						...
						<div className="flex items-start gap-[1.5vw]">
							<div
								onClick={() => setForm((f) => ({ ...f, different_to_home_address: !f.different_to_home_address }))}
								className={`flex-shrink-0 w-[1.4vw] h-[1.4vw] border-[3px] border-[#0e387a] rounded-md cursor-pointer mt-[0.3vw] transition-colors ${form.different_to_home_address ? "bg-[#F393B4]" : "bg-white"}`}
							/>
